...
qmmm_system.mm_system.damp_charge_only = False # default True
...
plt.plot(R_vals*1.0e1,(energies-E_qmmm_0)*1e3,label="State energy ")
...
plt.rc('font', family='Helvetica') 
plt.plot(R_vals*1.0e1,(energies-E_refs[None,:])*1e3,label="Interaction energy ")
plt.xlabel("Separation [Angstrom]")
plt.ylabel("Energy [mH]")
plt.legend()
plt.show()
