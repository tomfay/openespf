...
mol = gto.M(atom="3-inputs/acrolein.xyz",unit="Angstrom",basis="STO-3G",charge=0)
...
for x in range(0,3):
    np.savetxt("./3-inputs/output-"+str(x)+".dat",np.hstack((R_vals[2:-2,None],energies[x,2:-2,None],forces_num[x][2:-2,None],forces_an[x][2:-2,None])),header="R [Bohr],Energy [au],Numerical force[au],Analytical force[au]")
